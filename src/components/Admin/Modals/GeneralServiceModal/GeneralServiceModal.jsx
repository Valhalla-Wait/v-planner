...
import { schemaGeneralService } from '../../../../validation/schemas'
import f from '../../../../validation/fieldName'
import Input from '../../UI/Input/Input'
import cls from "./GeneralServiceModal.module.scss"
import { yupResolver } from '@hookform/resolvers/yup'
import { useForm } from 'react-hook-form'

const GeneralServiceModal = ({ callback, header, footer, name = "", price = "" }) => {
    ...
    const {
        ...
        mode: "all",
        resolver: yupResolver(schemaGeneralService()),
        defaultValues: {
            name: name,
            price: price
        }
        ...
        <ModalMiddleContent>
            <form onSubmit={handleSubmit(handleClick)}>
                ...
                <div className={cls.body}>
                    ...
                    <Input
                        className={cls.input}
                        isValid={isValidField(f.price)}
                        error={getErrorField(f.price)}
                        register={register(f.price)}
                    />
                </div>
